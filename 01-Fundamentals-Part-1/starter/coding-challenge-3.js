...
const dolphinsAverageScore = (97 + 112 + 7) / 3;
const koalasAverageScore = (109 + 95 + 7) / 3;
console.log(`Dolphins achieved ${dolphinsAverageScore} average.`);
console.log(`Koalas achieved ${koalasAverageScore} average.`);
...
if (dolphinsAverageScore >= 100 || koalasAverageScore >= 100) {
    if (dolphinsAverageScore > koalasAverageScore) {
        ...
        console.log("Two teams have the same average score. Both teams win!🎉");
    }
} else {
    console.log("Either team won!😖");
}